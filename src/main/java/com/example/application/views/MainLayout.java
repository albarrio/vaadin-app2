...
import com.example.application.views.mainview.MainViewView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        H1 appName = new H1("Demo Tractiva 2024");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Main View", LineAwesomeIcon.PENCIL_RULER_SOLID.create(), MainViewView.class), //
